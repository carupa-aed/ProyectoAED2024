...
```
A pesar que la gráfica del codo parece indicar ser mejor k=4, como se observa que el añadir el 5o lo que hace es crear un cluster propio a los outliers, optamos por coger k=5.
