...
\href{mailto:rosique2@alumni.uv.es}{\nolinkurl{rosique2@alumni.uv.es}}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0221}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9779}}@{}}
...
\bottomrule\noalign{}
\endlastfoot
1 & 37 Recogida y tratamiento de aguas residuales; 39 Actividades de
