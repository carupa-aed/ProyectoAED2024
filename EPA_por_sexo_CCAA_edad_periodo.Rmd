...
Como se ha mencionado anteriormente en la introducción, la Encuesta de Población Activa es realizada trimestralmente por el Instituto Nacional de Estadística, por lo que se han extraído cinco datasets de su base de datos: población total, activa, inactiva, ocupada y parada.
...
```{r, include=FALSE}
# Al tratarse de un análisis del mercado laboral tenemos que eliminar al grupo de población menor a 16 años pues no tienen edad suficiente para trabajar
# Renombramos las columnas
# Como hay una columna que solo contiene "Total Nacional", la eliminamos. Además, dentro de Comunidades y Ciudades Autónomas hay valores faltantes que coinciden con el propio Total Nacional por lo que los renombramos a "Total Nacional"
