...
```{r, warning=FALSE, echo=FALSE, out.width='60%', fig.align='center', fig.cap="Gráfico de codo global para la tasa de empleo", fig.pos="h"}
...
# Mostrar la tabla con kable
kable(tabla_ramas, col.names = c("Cluster", "Primeras tres Ramas de Actividad"), 
