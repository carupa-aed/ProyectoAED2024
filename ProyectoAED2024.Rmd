...
```{r, warning=FALSE, echo=FALSE,  fig.align='center', fig.cap="Gráfico de codo global para la tasa de empleo", fig.pos="h",fig.width=5.5, fig.height=3}
...
```{r, warning=FALSE, echo=FALSE, fig.align='center',fig.width=5.5, fig.height=2.25, fig.cap="Proyección MDS de las distancias entre la evolución de ramas de actividad normalizadas."}
...
```{r, warning=FALSE, echo=FALSE, fig.align='center',fig.width=5.5, fig.height=3, fig.cap="Gráfico del método del codo y representación mediante una proyección MDS de los clusters de k-means, con el parámetro $k$ escogido."}
