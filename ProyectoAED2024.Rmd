...
```{r, warning=FALSE, echo=FALSE, fig.align='center',fig.width=5.5, fig.height=3, fig.cap="Proyección MDS de las distancias entre la evolución de ramas de actividad normalizadas."}
