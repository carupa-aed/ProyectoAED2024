...
library(dplyr)
library(patchwork)
library(stringr)  # Para usar str_wrap()
...
Analizando los cuantiles y medias de cada cluster, se observa que se agrupan segun rendimiento, cosa a esperada proviniendo de la métrica definida. Se observan que la mayoría de las ramas de actividad se acumulan en los clústeres con la evolución negativa o mediocre, en los cuales ha habido un decrecimiento (cluster 2) o estancamiento (cluster 3) de los trabajadores. Por otra parte el cluster 1 parece presentar ramas con resultados positivos, aunque con menor número de ramas que los anteriores.